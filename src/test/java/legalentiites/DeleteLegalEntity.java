...
public class DeleteLegalEntity {
	...
	public static void clickAppLauncherthenLegalEntitiesDeleteEntity(String name) throws Exception {
		WebElement AppLauncher, ViewAll,LegalEntities,Search, ActionsBox, DeleteOption, DeleteButton, Message;
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenLegalEntitiesDeleteEntity("Raja");
		// closeBrowser();
	}
