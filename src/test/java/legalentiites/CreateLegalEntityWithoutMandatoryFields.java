...
public class CreateLegalEntityWithoutMandatoryFields {
	...
	public static void clickAppLauncherthenLegalEntitiescreateNewAccount(String companyname,String description) throws Exception {
		WebElement AppLauncher, ViewAll,LegalEntities,New,CompanyName,Description,
		StatusOptions,Status,Save,CloseErrorDialog,VerifyAlert;
		...
		AppLauncher.click();
		// click view all and then click LegalEntities from app launcher
		...
		VerifyAlert = driver.findElement(By.xpath("//div[@class='slds-form-element__help']"));
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenLegalEntitiescreateNewAccount("Tetsleaf", "SalesForce");
		// closeBrowser();
	}
