...
public class EditLegalEntity {
	...
	// Create WebDriver interface and FirefoxDriver,ChromeDriver,Edge Driver classes
		...
		public static void clickAppLauncherthenLegalEntitiesEditAccount(String name,String companyname,String description) throws Exception {
			WebElement AppLauncher, ViewAll,LegalEntities,Search,ActionsBox,Edit,CompanyName,
			Description,StatusOptions,Status,Save,ChangeView,View,VerifyStatus;
			...
			js.executeScript("arguments[0].scrollIntoView()", driver.findElement(By.xpath("//a[@data-label='Legal Entities']")));
			LegalEntities=driver.findElement(By.xpath("//a[@data-label='Legal Entities']"));
			js.executeScript("arguments[0].click();", LegalEntities);
			Thread.sleep(5000);
			Search=driver.findElement(By.xpath("//input[@name='LegalEntity-search-input']"));
			...
			Edit.click();
			CompanyName=driver.findElement(By.xpath("//input[@name='CompanyName']"));
			CompanyName.sendKeys(companyname);
			Description=driver.findElement(By.xpath("//div[@data-target-selection-name='sfdc:RecordField.LegalEntity.Description']//textarea"));
			Description.sendKeys(description);
			js.executeScript("arguments[0].scrollIntoView()", driver.findElement(By.xpath("//div[@data-target-selection-name='sfdc:RecordField.LegalEntity.Status']//button")));
			StatusOptions=driver.findElement(By.xpath("//div[@data-target-selection-name='sfdc:RecordField.LegalEntity.Status']//button"));
			StatusOptions.click();
			Status=driver.findElement(By.xpath("//lightning-base-combobox-item[@data-value='Active']"));
			Status.click();
			// click save and verify status name
			Save = driver.findElement(By.xpath("//button[@name='SaveEdit']"));
			Save.click();
			Thread.sleep(3000);
			ChangeView=driver.findElement(By.xpath("//h1/../.."));
			js.executeScript("arguments[0].click();", ChangeView);
			View=driver.findElement(By.xpath("//ul[@role='listbox']//a"));
			View.click();
			Thread.sleep(5000);
			VerifyStatus=driver.findElement(By.xpath("(//tr/td)[5]//span[@class='slds-truncate']"));
			String status = VerifyStatus.getText();
			status.trim();
			if (status.contains("Active")) {
				System.out.println("Status Verified Both are Same : " + status);
			}
		}
		...
		public static void main(String[] args) throws Exception {
			...
			clickAppLauncherthenLegalEntitiesEditAccount("Raja","Tetsleaf","SalesForce");
			// closeBrowser();
		}
