...
public class CreateLegalEntity {
	...
	// Create WebDriver interface and FirefoxDriver,ChromeDriver,Edge Driver classes
		...
		public static void clickAppLauncherthenLegalEntitiescreateNewAccount(String name) throws Exception {
			WebElement AppLauncher, ViewAll,LegalEntities,New,Name,Save,GoToDetails,FinalLegalEnityName;
			...
			New.click();
			Name=driver.findElement(By.xpath("//div[@data-target-selection-name='sfdc:RecordField.LegalEntity.Name']//input"));
			Name.sendKeys("Salesforce Automation by "+name);
			// click save and verify entity name
			Save = driver.findElement(By.xpath("//button[@name='SaveEdit']"));
			Save.click();
			GoToDetails = driver.findElement(By.xpath("//a[@id='detailTab__item']"));
			GoToDetails.click();
			FinalLegalEnityName = driver.findElement(By.xpath("//div[@data-target-selection-name='sfdc:RecordField.LegalEntity.Name']//lightning-formatted-text"));
			String finalname = FinalLegalEnityName.getText();
			finalname.trim();
			if (finalname.contains("Salesforce Automation by "+name)) {
				System.out.println("Both Legal Entity name are same:" + finalname);
			}
		...
		public static void main(String[] args) throws Exception {
			...
			clickAppLauncherthenLegalEntitiescreateNewAccount("Mercy");
			// closeBrowser();
		}
