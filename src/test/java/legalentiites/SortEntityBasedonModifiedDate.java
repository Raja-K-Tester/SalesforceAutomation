...
public class SortEntityBasedonModifiedDate {
	...
	public static void clickAppLauncherthenLegalEntitiesandSortEntity() throws Exception {
		WebElement AppLauncher, ViewAll,LegalEntities,LastModifiedDate;
		...
		Thread.sleep(5000);
		LastModifiedDate=driver.findElement(By.xpath("//th[@title='Last Modified Date']//a"));
		//It will be sorted based on the last modified date in descending order(Already in ascending order)
		js.executeScript("arguments[0].click();", LastModifiedDate);
		Thread.sleep(3000);
		//It will be sorted based on the last modified date in ascending order
		js.executeScript("arguments[0].click();", LastModifiedDate);
	}
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenLegalEntitiesandSortEntity();
		// closeBrowser();
	}
