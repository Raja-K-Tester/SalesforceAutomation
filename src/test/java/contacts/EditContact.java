...
public class EditContact {
	...
	// Create WebDriver interface and FirefoxDriver,ChromeDriver,Edge Driver classes
			...
			public static void clickAppLauncherthenContactsCreateNewContact(String name,String title,String birthdate,String phone) throws Exception {
				WebElement AppLauncher, ViewAll,Contacts,ListView,Search,Actions,Edit,
				Title,Birthday,LeadSourceOptions,LeadSource,PhoneNumber,Save,
				VerifyPhoneNumber;
				...
				Birthday=driver.findElement(By.xpath("//input[@name='Birthdate']"));
				...
				LeadSource=driver.findElement(By.xpath("//lightning-base-combobox-item[@data-value='Purchased List']"));
				LeadSource.click();
				js.executeScript("arguments[0].scrollIntoView()",
						driver.findElement(By.xpath("//input[@name='Phone']")));
				PhoneNumber=driver.findElement(By.xpath("//input[@name='Phone']"));
				PhoneNumber.sendKeys(phone);
				Save=driver.findElement(By.xpath("//button[@name='SaveEdit']"));
				Save.click();
				Thread.sleep(5000);
				VerifyPhoneNumber=driver.findElement(By.xpath("//span[@class='forceOutputPhone slds-truncate']"));
				String verifyphone = VerifyPhoneNumber.getText();
				System.out.println("Both Number are Same : "+verifyphone);
			}
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenContactsCreateNewContact("Naveen Elumalai", "Test", "14/08/1992", "1234567890");
		//closeBrowser();
