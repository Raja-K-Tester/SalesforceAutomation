...
public class CreateNewCase {
	...
	public static void clickAppLauncherthenCasesCreateNewCase(String firstname,String lastname,String subject,String description) throws Exception
	{
		WebElement AppLauncher, ViewAll,Cases,New,CaseOriginOption,CaseOrigin,ContactName,
		NewContactName,FirstName,LastName,SaveContact,StatusOptions,Status,
		Subject,Description,Save,CaseNumber,SaveMessage;
		...
		StatusOptions.click();
		Status=driver.findElement(By.xpath("//lightning-base-combobox-item[@data-value='Escalated']"));
		Status.click();
		...
		CaseNumber=driver.findElement(By.xpath("//div[@data-target-selection-name='sfdc:RecordField.Case.CaseNumber']//lightning-formatted-text"));
		String casenumber = CaseNumber.getText();
		System.out.println("Case created successfully and number is "+casenumber);
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenCasesCreateNewCase("Raja","Krishnan","Testing","Dummy");
		// closeBrowser();
	}
