...
public class CreateServiceTerritories {
	...
	// Create WebDriver interface and FirefoxDriver,ChromeDriver,Edge Driver classes
		...
		public static void clickAppLauncherthenServiceTerritoriesCreateNewTerritory(String name,
				String city,String state, String country,String zipcode) throws Exception {
			WebElement AppLauncher, ViewAll,ServiceTerritories,New,ServiceName,
			SearchOperatingHours,OperatingHours,ActiveField,City,State,Country,Zipcode,Save,
			SaveMessage,VerifyServiceName;
			...
			New.click();
			ServiceName=driver.findElement(By.xpath("//input[@name='Name']"));
			...
			OperatingHours=driver.findElement(By.xpath("//li[@class='slds-listbox__item']//lightning-base-combobox-item"));
			wait.until(ExpectedConditions.visibilityOf(OperatingHours));
			OperatingHours.click();
			ActiveField=driver.findElement(By.xpath("//input[@name='IsActive']"));
			ActiveField.click();
			City=driver.findElement(By.xpath("//input[@name='city']"));
			js.executeScript("arguments[0].scrollIntoView()",
					driver.findElement(By.xpath("//input[@name='city']")));
			City.sendKeys(city);
			State=driver.findElement(By.xpath("//input[@name='province']"));
			State.sendKeys(state);
			Country=driver.findElement(By.xpath("//input[@name='country']"));
			Country.sendKeys(country);
			Zipcode=driver.findElement(By.xpath("//input[@name='postalCode']"));
			...
			VerifyServiceName=driver.findElement(By.xpath("//lightning-formatted-text[@slot='primaryField']"));
			String servicename = VerifyServiceName.getText();
			if(servicename.contains(name))
			{
				System.out.println("Both Service Name are Same : "+servicename);
			}
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenServiceTerritoriesCreateNewTerritory("Raja", "Chennai", "Tamilnadu", "India", "600008");
		//closeBrowser();
	}
