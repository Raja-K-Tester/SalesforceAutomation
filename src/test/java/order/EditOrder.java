...
public class EditOrder {
	...
	// Create WebDriver interface and FirefoxDriver,ChromeDriver,Edge Driver classes
		...
		{
			WebElement AppLauncher, ViewAll,ServiceConsole,HomeDropDown,Orders,Actions,
			Edit,ClearContract,ClearAccountName,SearchAccountName,SelectAccountName,SearchContractNumber,SelectContractName,Save,SaveMessage;
			...
			Actions.click();
			Edit=driver.findElement(By.xpath("//a[@data-target-selection-name='sfdc:StandardButton.Order.Edit']"));
			Edit.click();
			Thread.sleep(5000);
			ClearAccountName=driver.findElement(By.xpath("//div[@data-target-selection-name='sfdc:RecordField.Order.AccountId']//button[@title='Clear Selection']"));
			ClearAccountName.click();
			Thread.sleep(3000);
			...
			SelectAccountName=driver.findElement(By.xpath("//span[@title='Abhishek']"));
			SelectAccountName.click();
			ClearContract=driver.findElement(By.xpath("//div[@data-target-selection-name='sfdc:RecordField.Order.ContractId']//button[@title='Clear Selection']"));
			ClearContract.click();
			Thread.sleep(3000);
			...
			SelectContractName=driver.findElement(By.xpath("//span[@title='00000103']"));
			...
			List<WebElement> nameandcontractno = driver.findElements(By.xpath("//td//a[@data-refid='recordId']"));
			for (WebElement element : nameandcontractno) {
