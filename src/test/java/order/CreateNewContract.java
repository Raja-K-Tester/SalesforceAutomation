...
public class CreateNewContract {
	...
	// Create WebDriver interface and FirefoxDriver,ChromeDriver,Edge Driver classes
		...
		public static void clickAppLauncherthenServiceConsoleContractsNewContract(String accountname,String startdate,String contractperiod) throws Exception
		{
			WebElement AppLauncher, ViewAll,ServiceConsole,HomeDropDown,Contracts,New,
			AccountName,SelectAccountName,StartDate,ContractTerm,Save,SaveMessage,
			GoToDetails,ContractNumber;
			...
			HomeDropDown.click();
			Contracts=driver.findElement(By.xpath("//a[@data-label='Contracts']"));
			JavascriptExecutor js = (JavascriptExecutor) driver;
			js.executeScript("arguments[0].scrollIntoView(true);", Contracts);
			Contracts.click();
			Thread.sleep(5000);
			New=driver.findElement(By.xpath("//a[@title='New']"));
			New.click();
			AccountName=driver.findElement(By.xpath("//div[@data-target-selection-name='sfdc:RecordField.Contract.AccountId']//input"));
			js.executeScript("arguments[0].click();", AccountName);
			SelectAccountName=driver.findElement(By.xpath("//span[@title='"+accountname+"']"));
			SelectAccountName.click();
			StartDate=driver.findElement(By.xpath("//input[@name='StartDate']"));
			StartDate.sendKeys(startdate);
			ContractTerm=driver.findElement(By.xpath("//input[@name='ContractTerm']"));
			ContractTerm.sendKeys(contractperiod);
			...
			GoToDetails.click();
			ContractNumber=driver.findElement(By.xpath("//div[@data-target-selection-name='sfdc:RecordField.Contract.ContractNumber']//lightning-formatted-text"));
			String result = ContractNumber.getText();
			System.out.println("Contract Number is "+result);
			}
		...
		public static void main(String[] args) throws Exception {
			...
			clickAppLauncherthenServiceConsoleContractsNewContract("Abhishek","23/03/2024","60");
			//closeBrowser();
		}
