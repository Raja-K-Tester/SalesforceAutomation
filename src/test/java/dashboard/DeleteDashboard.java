...
public class DeleteDashboard {
	...
	// Create WebDriver interface and FirefoxDriver,ChromeDriver,Edge Driver classes
		...
		public static void clickAppLauncherthenDashboardDeleteDashboard(String name) throws Exception
		{
			WebElement AppLauncher, ViewAll, Dashboards, Search, ActionsBox,DeleteOption,
			...
			DeleteOption = driver.findElement(By.xpath("//span[text()='Delete']/.."));
			DeleteOption.click();
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenDashboardDeleteDashboard("Raja");
		// closeBrowser();
	}
