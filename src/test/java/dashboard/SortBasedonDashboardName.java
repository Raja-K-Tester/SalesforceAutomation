...
public class SortBasedonDashboardName {
	...
	// Create WebDriver interface and FirefoxDriver,ChromeDriver,Edge Driver classes
			...
			public static void clickAppLauncherthenDashboardSortDashboardName() throws Exception
			{
				WebElement AppLauncher, ViewAll, Dashboards, DashboardName;
				...
				Thread.sleep(5000);
				DashboardName=driver.findElement(By.xpath("//th[@aria-label='Dashboard Name']//a"));
				js.executeScript("arguments[0].click();", DashboardName);
				Thread.sleep(3000);
			}
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenDashboardSortDashboardName();
		// closeBrowser();
	}
