...
public class AttachDocument {
	...
	// Create WebDriver interface and FirefoxDriver,ChromeDriver,Edge Driver classes
		...
		public static void clickAppLauncherthenSalesCampaignsAttachDocumentToCampaign(String name) throws Exception {
			WebElement AppLauncher, ViewAll, Sales, Campaigns, CampaignsLink,
			UploadLink,Done,Message;
			...
			CampaignsLink.click();
			Thread.sleep(3000);
			UploadLink=driver.findElement(By.xpath("//span[contains(@class,'button slds-button')]"));
			js.executeScript("arguments[0].click();", UploadLink);
			Thread.sleep(4000);
			 Robot rb = new Robot();
			 StringSelection str = new StringSelection("D:\\FATCA declaration for all Accounts D1.pdf");
		...
		public static void main(String[] args) throws Exception {
			...
			clickAppLauncherthenSalesCampaignsAttachDocumentToCampaign("Bootcamp");
			// closeBrowser();
		}
