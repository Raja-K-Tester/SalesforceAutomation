...
public class DeleteContactForCampaign {
	...
	public static void clickAppLauncherthenSalesDeleteContact(String name,String firstname,String lastname) throws Exception {
		...
		ContactsLink,ListView,Search,Actions,DeleteOption,DeleteButton,Message,ViewAllLink,
		...
		Filters.click();
		FilterTypeContact=driver.findElement(By.xpath("(//label[@class='slds-checkbox__label']/span[@class='slds-checkbox_faux'])[4]"));
