...
public class CreateCampaign {
	...
	public static void clickAppLauncherthenSalesCampaignsNewCampaign(String name) throws Exception {
		WebElement AppLauncher, ViewAll, Sales, Campaigns, New, CampaignName, StartDate, EndDate, Save, SaveMessage,
				GoToDetails, VerifyCampaignName;
		...
		Thread.sleep(3000);
		CampaignName = driver
				.findElement(By.xpath("//div[@data-target-selection-name='sfdc:RecordField.Campaign.Name']//input"));
		CampaignName.sendKeys(name);
		StartDate = driver.findElement(
				By.xpath("//div[@data-target-selection-name='sfdc:RecordField.Campaign.StartDate']//input"));
		// Get the current date and go to next date and format date as dd/MM/yyyy
		...
		EndDate = driver
				.findElement(By.xpath("//div[@data-target-selection-name='sfdc:RecordField.Campaign.EndDate']//input"));
		LocalDate dayaftertomorrow = LocalDate.now();
		dayaftertomorrow = dayaftertomorrow.plusDays(2);
		...
		GoToDetails.click();
		Thread.sleep(3000);
		VerifyCampaignName=driver.findElement(By.xpath("//div[@data-target-selection-name='sfdc:RecordField.Campaign.Name']//span[@class='uiOutputText']"));
		String result = VerifyCampaignName.getText();
		System.out.println("Campaign Name is "+result);
	}
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenSalesCampaignsNewCampaign("Bootcamp");
		// closeBrowser();
	}
