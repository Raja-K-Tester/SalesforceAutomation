...
public class DeleteOpportunityForCampaign {
	...
	public static void clickAppLauncherthenSalesDeleteOpportunity(String name,String firstname) throws Exception {
		WebElement AppLauncher, ViewAll, Sales, Campaigns, CampaignsLink,
		CampaignOpportunitiesLink,Actions,DeleteOption,DeleteButton,Message,Opportunities,
		Filters,FilterStageType,Apply,Search;
		...
		Actions=driver.findElement(By.xpath("(//a[contains(@class,'rowActionsPlaceHolder')])[2]"));
		Actions.click();
		DeleteOption=driver.findElement(By.xpath("//a[@data-target-selection-name='sfdc:StandardButton.Opportunity.Delete']"));
		DeleteOption.click();
		...
		Thread.sleep(3000);
		CampaignOpportunitiesLink=driver.findElement(By.xpath("//span[@title='Opportunities']/.."));
		js.executeScript("arguments[0].click();", CampaignOpportunitiesLink);
		Thread.sleep(3000);
		Filters=driver.findElement(By.xpath("//button[@title='Show quick filters']"));
		Filters.click();
		FilterStageType=driver.findElement(By.xpath("//label//span[text()='Needs Analysis']"));
		FilterStageType.click();
		Apply=driver.findElement(By.xpath("//button[@title='Apply']"));
		Apply.click();
		Thread.sleep(5000);
		Opportunities=driver.findElement(By.xpath("//a[@title='Opportunities']"));
		js.executeScript("arguments[0].click();", Opportunities);
		Thread.sleep(5000);
		Search=driver.findElement(By.xpath("//input[@placeholder='Search this list...']"));
		Search.sendKeys("Opportunity from "+firstname);
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenSalesDeleteOpportunity("Bootcamp","Raja");
		// closeBrowser();
	}
