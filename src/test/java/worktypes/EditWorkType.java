...
public class EditWorkType {
	...
	public static void clickAppLauncherthenWorkTypesEditWorktype(String name,
		...
		TimeFrameEnd,Save,EditMessage,WorkTypeName,StartFrame,EndFrame;
		...
		Save.click();
		Thread.sleep(3000);
		EditMessage=driver.findElement(By.xpath("//span[@class='toastMessage slds-text-heading--small forceActionsText']"));
		String message = EditMessage.getText();
		System.out.println(message);
		WorkTypeName=driver.findElement(By.xpath("//a[@data-refid='recordId']"));
		WorkTypeName.click();
		Thread.sleep(5000);
		StartFrame=driver.findElement(By.xpath("//div[@data-target-selection-name='sfdc:RecordField.WorkType.TimeframeStart']//span[@class='uiOutputNumber']"));
		String starttime = StartFrame.getText();
		System.out.println("TimeFrame Start is : "+starttime);
		EndFrame=driver.findElement(By.xpath("//div[@data-target-selection-name='sfdc:RecordField.WorkType.TimeframeEnd']//span[@class='uiOutputNumber']"));
		String endtime = EndFrame.getText();
		System.out.println("TimeFrame End is : "+endtime);
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenWorkTypesEditWorktype("Salesforce Project",9,18);
		// closeBrowser();
	}
