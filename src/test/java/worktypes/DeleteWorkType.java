...
public class DeleteWorkType {
	...
	public static void clickAppLauncherthenWorkTypeDeleteWorkType(String name) throws Exception {
		WebElement AppLauncher, ViewAll, WorkTypes,Search,ActionsBox, DeleteOption, 
		...
		DeleteOption = driver.findElement(By.xpath("//a[@data-target-selection-name='sfdc:StandardButton.WorkType.Delete']"));
		DeleteOption.click();
		Thread.sleep(20000);
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenWorkTypeDeleteWorkType("Salesforce Project");
		// closeBrowser();
	}
