...
public class EditWorkTypeGroup {
	...
	public static void clickAppLauncherthenWorkTypeGroupsEditWorkTypeGroup(String name,String description) throws Exception {
		WebElement AppLauncher, ViewAll, WorkTypeGroups,Search,ActionsBox, Edit, 
		WorkTypeGroupDescription, Save,FinalGroupDescription,GroupTypeOption,
		GroupType,ClickGroupName;
		...
		Thread.sleep(5000);
		Search=driver.findElement(By.xpath("//input[@name='WorkTypeGroup-search-input']"));
		...
		Edit = driver.findElement(By.xpath("//a[@data-target-selection-name='sfdc:StandardButton.WorkTypeGroup.Edit']"));
		Edit.click();
		Thread.sleep(20000);
		WorkTypeGroupDescription = driver
				.findElement(By.xpath("//textarea"));
		WorkTypeGroupDescription.sendKeys(description);
		GroupTypeOption=driver.findElement(By.xpath("//div[@data-target-selection-name='sfdc:RecordField.WorkTypeGroup.GroupType']//button"));
		GroupTypeOption.click();
		GroupType=driver.findElement(By.xpath("//span[@title='Capacity']/../.."));
		GroupType.click();
		// click save and verify Group name
		Save = driver.findElement(By.xpath("//button[@name='SaveEdit']"));
		Save.click();
		Thread.sleep(3000);
		ClickGroupName=driver.findElement(By.xpath("//a[@data-refid='recordId']"));
		ClickGroupName.click();
		FinalGroupDescription = driver.findElement(By.xpath(
				"//div[@data-target-selection-name='sfdc:RecordField.WorkTypeGroup.Description']//lightning-formatted-text"));
		wait.until(ExpectedConditions.visibilityOf(FinalGroupDescription));
		String text = FinalGroupDescription.getText();
		text.trim();
		if (text.contains(description)) {
			System.out.println("Both description name are same: " + text);
		}
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenWorkTypeGroupsEditWorkTypeGroup("Mercy","Automation");
		// closeBrowser();
	}
