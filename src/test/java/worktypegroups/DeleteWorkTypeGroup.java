...
public class DeleteWorkTypeGroup {
	...
	public static void clickAppLauncherthenWorkTypeGroupsDeleteWorkTypeGroup(String name) throws Exception {
		WebElement AppLauncher, ViewAll, WorkTypeGroups,Search,ActionsBox, DeleteOption, 
		...
		DeleteOption = driver.findElement(By.xpath("//a[@data-target-selection-name='sfdc:StandardButton.WorkTypeGroup.Delete']"));
		DeleteOption.click();
		Thread.sleep(20000);
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenWorkTypeGroupsDeleteWorkTypeGroup("Mercy");
		// closeBrowser();
	}
