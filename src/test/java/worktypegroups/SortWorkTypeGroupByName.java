...
public class SortWorkTypeGroupByName {
	...
	public static void clickAppLauncherthenWorkTypeGroupsSortWorkTypeGroupByName() throws Exception {
		WebElement AppLauncher, ViewAll, WorkTypeGroups,SortByGroupName;
		...
		Thread.sleep(5000);
		SortByGroupName=driver.findElement(By.xpath("//th[@aria-label='Work Type Group Name']//a"));
		SortByGroupName.click();
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenWorkTypeGroupsSortWorkTypeGroupByName();
		// closeBrowser();
	}
