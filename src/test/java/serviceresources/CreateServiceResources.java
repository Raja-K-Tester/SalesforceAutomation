...
public class CreateServiceResources {
	...
	// Create WebDriver interface and FirefoxDriver,ChromeDriver,Edge Driver classes
		...
		public static void clickAppLauncherthenViewAllServiceResourcesCreateServiceResource(String name) throws Exception
		{
			WebElement AppLauncher,ViewAll,ServiceResources,InitialName,ShowAction,Edit,Name,
			Save,SaveMessage,VerifyName;
			...
			ServiceResources=driver.findElement(By.xpath("//a[@data-label='Service Resources']"));
			js.executeScript("arguments[0].scrollIntoView();",ServiceResources);
			js.executeScript("arguments[0].click();",ServiceResources);
			Thread.sleep(3000);
			InitialName=driver.findElement(By.xpath("//a[@title='K']"));
			String initialname = InitialName.getText();
			System.out.println("Before verification name is : "+initialname);
			ShowAction=driver.findElement(By.xpath("//a[contains(@class,'rowActionsPlaceHolder')]"));
			ShowAction.click();
			Edit=driver.findElement(By.xpath("//a[@data-target-selection-name='sfdc:StandardButton.ServiceResource.Edit']"));
			wait.until(ExpectedConditions.visibilityOf(Edit));
			Edit.click();
			Thread.sleep(4000);
			Name=driver.findElement(By.xpath("//input[@name='Name']"));
			Name.clear();
			Name.sendKeys(name);
			...
			Thread.sleep(3000);
			VerifyName=driver.findElement(By.xpath("//a[@title='"+name+"']"));
			String verifyname = VerifyName.getText();
			System.out.println("Name Verified : "+verifyname);
		}
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenViewAllServiceResourcesCreateServiceResource("Raja");
	}
