...
public class SortAccountsBasedonAccountName {
	...
	public static void clickAppLauncherthenSalesandSortAccountName() throws Exception {
		WebElement AppLauncher, ViewAll, Sales, Accounts,AccountName;
		...
		AccountName=driver.findElement(By.xpath("//th[@title='Account Name']//a"));
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenSalesandSortAccountName();
		// closeBrowser();
	}
