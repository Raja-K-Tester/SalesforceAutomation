...
public class DeleteAccount {
	...
	public static void clickAppLauncherthenSalesGotoAccountsandDeleteAccount(String name) throws Exception {
		WebElement AppLauncher, ViewAll, Sales,Accounts,Search,ActionsBox,DeleteOption,
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenSalesGotoAccountsandDeleteAccount("Abhishek");
		// closeBrowser();
	}
