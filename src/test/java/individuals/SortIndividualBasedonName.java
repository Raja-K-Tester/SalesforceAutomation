...
public class SortIndividualBasedonName {
	...
	public static void clickAppLauncherthenSortIndividualBasedonName() throws Exception {
		WebElement AppLauncher, ViewAll, Individuals,SortByName;
		...
		Thread.sleep(5000);
		SortByName=driver.findElement(By.xpath("//th[@title='Name']//a"));
		SortByName.click();
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenSortIndividualBasedonName();
		// closeBrowser();
	}
