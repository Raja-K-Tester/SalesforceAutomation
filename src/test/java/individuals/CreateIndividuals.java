...
public class CreateIndividuals {
	...
	public static void clickAppLauncherthenCreateNewIndividual(String lastname) throws Exception {
		WebElement AppLauncher, ViewAll, Individuals, NewIndividual, LastName, Save, GoToDetails, VerifyName;
		...
		GoToDetails.click();
		VerifyName = driver.findElement(By.xpath(
				"//div[@data-target-selection-name='sfdc:RecordField.Individual.Name']//span[@class='uiOutputText']"));
		String text = VerifyName.getText();
		if (text.contains(lastname))
		{
			System.out.println("Both name are matching : " + text);
		}
	}
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenCreateNewIndividual("Raja");
		// closeBrowser();
	}
