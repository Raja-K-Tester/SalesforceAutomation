...
public class DeleteIndividual {
	...
	public static void clickAppLauncherthenDeleteIndividual(String name) throws Exception {
		WebElement AppLauncher, ViewAll, Individuals,Search,ActionsBox,DeleteOption,
		...
		DeleteOption = driver.findElement(By.xpath("//a[@data-target-selection-name='sfdc:StandardButton.Individual.Delete']"));
		DeleteOption.click();
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenDeleteIndividual("Kumar");
		// closeBrowser();
	}
