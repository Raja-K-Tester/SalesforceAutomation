...
public class SortOpportunityCloseDate {
	...
	public static void clickAppLauncherthenSalesandSortOpportunity() throws Exception {
		WebElement AppLauncher, ViewAll, Sales, Opportunity,SelectListDisplay,Table,CloseDate;
		...
		Thread.sleep(3000);
		Table=driver.findElement(By.xpath("//li[@title='Display as table']"));
		Table.click();
		CloseDate=driver.findElement(By.xpath("(//a[@class='toggle slds-th__action slds-text-link--reset '])[5]"));
		//wait.until(ExpectedConditions.elementToBeClickable(CloseDate));
		//It will be sorted based on the close date in descending order(Already in ascending order)
		js.executeScript("arguments[0].click();", CloseDate);
		Thread.sleep(3000);
		//It will be sorted based on the close date in ascending order
		js.executeScript("arguments[0].click();", CloseDate);
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenSalesandSortOpportunity();
		// closeBrowser();
	}
