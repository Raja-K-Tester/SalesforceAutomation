...
public class CreateOpportunityWithoutMandatoryFields {
	...
	public static void clickAppLauncherthenSalesandEditSalesOpportunity() throws Exception {
		WebElement AppLauncher, ViewAll, Sales, Opportunity,New,CloseDate,
		Save,CloseErrorDialog;
		List<WebElement> VerifyMultipleAlerts;
		...
		VerifyMultipleAlerts=driver.findElements(By.xpath("//div[@class='slds-form-element__help']"));
	...
	public static void main(String[] args) throws Exception {
		...
		clickAppLauncherthenSalesandEditSalesOpportunity();
		// closeBrowser();
	}
